...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favouriteById_fkey" FOREIGN KEY ("favouriteById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
